...
def parseCommandLine():
    ...
    parser.add_option("--profile_name", action="store",
                      dest="ProfileString", default="BMC",
...
def main():
    ...
    sCommand        = "start \"PuTTY Start Window\" \"C:/Users/Public/Desktop/putty.exe\" -load %s -ssh -l root -pw `Admin20" % oCmdlineOptions.ProfileString
