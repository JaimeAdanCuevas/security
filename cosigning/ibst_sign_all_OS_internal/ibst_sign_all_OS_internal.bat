...
set IBST_PATH=C:\share\CoSignedIFWIBuild\Tools\SPS_SoC-A_05.00.02.015.0\Tools\IbstTool\
...
set ME_REGION_PATH=C:\share\CoSignedIFWIBuild\Tools\SPS_SoC-A_05.00.02.015.0\

::Path to PMC PATCH (pmcp.bin)
set PMCP_PATH=C:\share\CoSignedIFWIBuild\Tools\SPS_SoC-A_05.00.02.015.0\Tools\FlashImageTool\
...
%PY_PATH%/python.exe %IBST_PATH%/ibst.py  config/CoSign.xml --config_override %OVERRIDE_PATH%/CoSign_override_PMCP_With_Footer_internal.xml  -s cosign_key="%KEY_PATH%/PMCP_3K_PRIVATE.pem"   input_file="%PMCP_PATH%/CDFH_B0_PMC_FW_000.02.10.1001.3K_footer_pmcp.bin" output_name="%OUTPUT_PATH%/PMCP_Cosigned_internal.bin"
...
%PY_PATH%/python ./ibst.py  config/CoSigningManifest.xml --config_override %OVERRIDE_PATH%/CoSigningManifest_override_ACM_internal.xml  -s key="%KEY_PATH%/ACM_3K_PRIVATE.pem" binary_hash="e0f8de8243b77771e9fa0afc96a2ac4316a94ee5cc9fb9d4019efa586096e195" output_name="%OUTPUT_PATH%/ACMM_internal.bin" 

echo 		################# ACM Done #################

echo 		################# Signing FIT Patch #################

%PY_PATH%/python ./ibst.py  config/CoSigningManifest.xml --config_override %OVERRIDE_PATH%/CoSigningManifest_override_FITP_internal.xml  -s key="%KEY_PATH%/FITP_3K_PRIVATE.pem" binary_hash="97cb22175819c7254fd48acb19a01c048d1619f9f4e3d7ac04cda6a99cf78c7e"  output_name="%OUTPUT_PATH%/FPM_internal.bin"

echo 		################# FIT Patch Done #################

echo  	@@@@@@@@@@@@@@ BIOS Region Images signing Done  @@@@@@@@@@@@@@@@@

echo 		################# Signing OS Kernel #################
%PY_PATH%/python ./ibst.py  config/CoSigningManifest.xml --config_override %OVERRIDE_PATH%/CoSigningManifest_OS_RHEL8_override.xml  -s key="%KEY_PATH%/OS_3K_PRIVATE.pem"  module_bin="%OS_PATH%\shimx64.efi" output_name="%OUTPUT_PATH%/shimx64.efi.bin"                 


echo 		################# Signing bootx64.efi #################
%PY_PATH%/python ./ibst.py  config/CoSigningManifest.xml --config_override %OVERRIDE_PATH%/CoSigningManifest_NL_RHEL8_override.xml  -s key="%KEY_PATH%/NL_3K_PRIVATE.pem"  module_bin="%OS_PATH%\BOOTX64.efi" output_name="%OUTPUT_PATH%/BOOTX64.efi.bin"                 


echo  	@@@@@@@@@@@@@@ OS Manifests Done  @@@@@@@@@@@@@@@@@
