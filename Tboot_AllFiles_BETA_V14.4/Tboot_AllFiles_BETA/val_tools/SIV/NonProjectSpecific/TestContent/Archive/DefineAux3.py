...
# $Revision$
############################################################################
#This script define AUX3 index in TPM
...
def main():
    ...
    LogDelimiter()
    if(os.system("tpmnv_getcap |grep 0x50000003")==0):
	print "AUX3 already defined....."
    else:	
	m=os.system("tpmnv_getcap | grep 0x50000003 || tpmnv_defindex -i 0x50000003 -p ownerauth -s 96 -pv 0x0 -rl 0x1f -wl 0x18")
    	if m==0:
		print ' Successfully Defined AUX3.......'
    	else:
		print ' Failed Defining AUX3.......'
		return 1
