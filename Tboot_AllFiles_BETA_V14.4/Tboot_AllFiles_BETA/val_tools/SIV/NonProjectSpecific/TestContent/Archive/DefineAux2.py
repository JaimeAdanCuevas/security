...
# $Revision$
############################################################################
#This script define AUX2 index in TPM
...
def main():
    ...
    LogDelimiter()
    if(os.system("tpmnv_getcap | grep 0x50000002")==0):
    	print "AUX2 already defined......"
	
    else:    
   	m=os.system("tpmnv_getcap | grep 0x50000002 || tpmnv_defindex -i 0x50000002 -p ownerauth -s 96 -pv 0x0")
   	if m==0:
		print ' Successfully Defined AUX2.......'
    	else:
		print ' Failed Defining AUX2.......'
		return 0
