...
class DependencyFactory:
    ...
    @classmethod
    def create_dependency(cls, dependency_type: str, properties, owner_component) -> Dependency:
        ...
        return cls._dependency_types_map[dependency_type](properties, owner_component)
