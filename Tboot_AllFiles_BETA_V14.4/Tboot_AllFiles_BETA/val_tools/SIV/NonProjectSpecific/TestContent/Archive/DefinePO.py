...
# $Revision$
############################################################################
#This script define PO index in TPM
...
def main():
	...
	print "PO index already defined...."
    else:
    	m=os.system("tpmnv_getcap | grep 0x40000001 || tpmnv_defindex -i owner -p ownerauth")
    	if m==0:
    		print ' Successfully Defined P0index.......'
        	return 1
    	else:
        	print ' Failed Defining P0index.......'
        	return 0
    LogDelimiter()
    logger.info("Pass")
    LogDelimiter()
