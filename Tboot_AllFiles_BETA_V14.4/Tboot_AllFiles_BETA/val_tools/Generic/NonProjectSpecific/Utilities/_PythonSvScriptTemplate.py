...
#| $Revision: 191 $
#| $HeadURL: http://dpvsvn/svn/val_tools/Generic/NonProjectSpecific/Utilities/_PythonScriptTemplate.py $
#| $Id: _PythonSvScriptTemplate.py 191 2015-09-02 13:34:00Z amr\egross $
#| $Header: https://jf4gapp1008.amr.corp.intel.com/svn/val_tools/Generic/NonProjectSpecific/Utilities/_PythonSvScriptTemplate.py 191 2015-09-02 13:34:00Z amr\egross $
#| $Author: amr\egross $
...
__svn_headurl__         = "$HeadURL: http://dpvsvn/svn/val_tools/Generic/NonProjectSpecific/Utilities/_PythonScriptTemplate.py $"[10:-2]
__svn_id__              = "$Id: _PythonSvScriptTemplate.py 191 2015-09-02 13:34:00Z amr\egross $"[5:-2]
__svn_header__          = "$Header: https://jf4gapp1008.amr.corp.intel.com/svn/val_tools/Generic/NonProjectSpecific/Utilities/_PythonSvScriptTemplate.py 191 2015-09-02 13:34:00Z amr\egross $"[9:-2]
...
def parseCommandLine():
    ...
    _log.debug("Favorite Color   option read as %s" % oCmdlineOptions.FavoriteColor   )
    _log.debug("Lucky Number     option read as %s" % oCmdlineOptions.LuckyNum        )
    _log.debug("Meeting Location option read as %s" % oCmdlineOptions.MeetingLocation )
